...
$api = new gabiaSmsApi('m9610773','1d23970a110640394684916a08c1bd99');

$oBuffer = array("010-2810-5270");	
...
foreach($oBuffer as $p)
{
	...
	$r = $api->lms_send($p, "02-783-3652", "test", "test", "1211212111111212", "0");			//장문 전송
